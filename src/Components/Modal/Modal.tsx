      ...
      {showModal && (
        ...
        >
          <motion.div
            ...
            className='grid max-h-[95vh] w-[95vw] max-w-[95vw] content-start gap-8 overflow-auto rounded-2xl border-2 border-neutral-900 bg-neutral-950 p-8 shadow-lg md:w-[700px]'
          >
